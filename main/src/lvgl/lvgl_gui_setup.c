...
void lvgl_gui_user_screen()
{
    ...
    lvgl_gui->user_tabview_tab3 = lv_tabview_add_tab(lvgl_gui->user_tabview , "用户信息");
    ...
    lv_chart_set_range(lvgl_gui->user_tabview_tab2_chart_volt, 200, 250);
    ...
    lv_chart_set_y_tick_texts(lvgl_gui->user_tabview_tab2_chart_volt , "250\n220\n190" , 0 , LV_CHART_AXIS_DRAW_LAST_TICK);
    ...
    lv_chart_set_range(lvgl_gui->user_tabview_tab2_chart_curr, 0, 4);
    ...
    lv_chart_set_y_tick_texts(lvgl_gui->user_tabview_tab2_chart_curr , "4\n2\n0" , 0 , LV_CHART_AXIS_DRAW_LAST_TICK);
    ...
    lv_chart_set_range(lvgl_gui->user_tabview_tab2_chart_power, 0, 1000);
    ...
    lv_chart_set_y_tick_texts(lvgl_gui->user_tabview_tab2_chart_power , "1000\n500\n0" , 0 , LV_CHART_AXIS_DRAW_LAST_TICK);
